...
class TwoStageParser(object):
    def train(self, train_set):
        ...
        self.classifier = GridSearchCV(svm, parameters, scoring=make_scorer(f2_score))
    ...
    def test(self, test_set):
        ...
        for source, group in test_set:
            ...
            best_indices = np.argsort(predictions)[::-1][:250]
            best_score = 0.0
            best_item = group[0]
    ...
    def get_example_features(self, example):
        ...
        return {f: 1.0 for f in target_tokens}
